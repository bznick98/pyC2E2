...
class JacobianCalc:
    '''
    Operational Class used for calculate jacobian
    '''
    # PATH to the current file(jacobiancalc.py)
    ...
    def createCDFfunction(delete_element):
        ComputeLDFstring = ""
        ComputeLDFstring += "\n"
        open_path = JacobianCalc.current_file_path + "../work-dir/ThinVarProp"
        with open(open_path,'r') as thinvarfile:
